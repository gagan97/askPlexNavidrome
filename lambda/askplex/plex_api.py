...
class PlexConnection:
    ...
    def get_cover_art_url(self, song_id: str) -> str:
        """Get cover art URL for a given song

        :param str song_id: A song rating key
        :return: A properly formatted cover art URL
        :rtype: str
        """
        ...
        try:
            ...
            self.logger.error(f'Error getting cover art URL: {e}')
